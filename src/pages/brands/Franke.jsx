...
// export default function Franke() {
//   return (
//     <div>
//       <Header />

//       <section className="py-10 mt-20 px-4 max-w-6xl mx-auto">
//         <h1 className="text-3xl sm:text-4xl font-bold text-center mb-6">Franke</h1>
...
//           <h1 className="text-4xl sm:text-5xl font-bold mb-4">Franke</h1>
//           <p className="text-lg sm:text-xl opacity-90">
//             World-class kitchen solutions built with Swiss precision.
//           </p>
//         </div>
//       </div>
...
//         <h2 className="text-2xl font-bold mb-4">About Franke</h2>
//         <p className="text-gray-700 leading-relaxed mb-6">
//           Franke is a global leader in premium kitchen systems, offering
//           innovative and durable products crafted for modern homes and
//           professional kitchens.
//         </p>

//         <h2 className="text-2xl font-bold mb-4">What We Offer</h2>
//         <p className="text-gray-700 leading-relaxed mb-10">
//           We provide the complete Franke product portfolio including sinks,
//           faucets, chimneys, and built-in luxury appliances.
//         </p>
//       </section>
...
import Footer from "../../components/home/Footer";
import { motion } from "framer-motion";
import logo from "../../assets/franke.png";
    ...
    <div className="bg-white">
      ...
      <div className="bg-[#0c2d48] text-white py-20 mt-20 relative px-4">
        ...
        <div className="relative z-10 max-w-5xl mx-auto flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="text-center sm:text-left">
            <h1 className="text-4xl sm:text-5xl font-bold mb-2">Franke</h1>
      ...
      <section className="py-12 px-4 max-w-5xl mx-auto">
        ...
        <p className="text-gray-700 mb-6 leading-relaxed">
          Franke is a global leader in premium kitchen systems.
        </p>

        <h2 className="text-2xl font-bold mb-4">What We Offer</h2>
        <p className="text-gray-700 mb-10 leading-relaxed">
          We provide sinks, faucets, chimneys, and built-in appliances.
        </p>
      </section>
