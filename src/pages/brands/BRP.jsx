...
//         <h1 className="text-3xl sm:text-4xl font-bold text-center mb-6">BRP</h1>
...
//           <h1 className="text-4xl sm:text-5xl font-bold mb-4">BRP</h1>
//           <p className="text-lg sm:text-xl opacity-90">
//             Trusted provider of piping and supply line solutions.
//           </p>
//         </div>
//       </div>

//       <section className="py-12 px-4 max-w-5xl mx-auto">
//         <h2 className="text-2xl font-bold mb-4">About BRP</h2>
//         <p className="text-gray-700 mb-6 leading-relaxed">
//           BRP delivers durable and long-lasting piping solutions for water,
//           industrial, and residential applications.
//         </p>

//         <h2 className="text-2xl font-bold mb-4">What We Offer</h2>
//         <p className="text-gray-700 mb-10 leading-relaxed">
//           A wide range of high-quality pipes and fittings engineered for
...
import Footer from "../../components/home/Footer";
import { motion } from "framer-motion";
import logo from "../../assets/brp.png";
      ...
      <div className="bg-[#0c2d48] text-white py-20 mt-20 relative px-4">
        ...
        <div className="relative z-10 max-w-5xl mx-auto flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="text-center sm:text-left">
            <h1 className="text-4xl sm:text-5xl font-bold mb-2">BRP</h1>
