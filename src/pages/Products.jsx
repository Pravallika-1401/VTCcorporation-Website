...
// // 11 BRAND DATA
// const brandCards = [
//   { name: "Schneider Electric", image: schneider, products: ["Switches & Sockets", "MCB / RCCB / DB", "Wiring Devices", "Industrial Controls", "Automation Products"] },
//   { name: "Polycab", image: polycab, products: ["Wires & Cables", "House Wiring", "Power Cables", "Flexible Cables", "Switchgear"] },
//   { name: "RN (Rathna Syndicate)", image: rn, products: ["Electrical Hardware", "Switches & Boards", "Industrial Components", "Cables & Accessories"] },
//   { name: "Geberit", image: geberit, products: ["Concealed Cisterns", "Flush Plates", "Plumbing Systems", "Drainage Pipes", "Installation Systems"] },
//   { name: "Precision", image: precision, products: ["PVC Pipes", "UPVC Pipes", "CPVC Pipes", "Plumbing Fittings"] },
//   { name: "Astral", image: astral, products: ["CPVC Pipes", "PVC Pipes", "SWR Pipes", "Plumbing Fittings", "Industrial Pipes"] },
//   { name: "BRP", image: brp, products: ["Plumbing Pipes", "Pipe Fittings", "Water Supply Systems"] },
//   { name: "Cera", image: cera, products: ["Sanitaryware", "Faucets", "Showers", "Bathroom Accessories", "Kitchen Sinks"] },
//   { name: "Franke", image: franke, products: ["Kitchen Sinks", "Kitchen Faucets", "Chimneys", "Built-in Appliances"] },
//   { name: "Mapei", image: mapei, products: ["Tile Adhesives", "Grouts", "Waterproofing", "Surface Preparation"] },
//   { name: "Nikolas", image: nikolas, products: ["Pipes", "Plumbing Fittings", "CPVC / UPVC Systems"] }
// ];
...
//             <p className="text-xl text-gray-200 max-w-3xl mx-auto leading-relaxed mb-10">
//               Complete building materials sourced from the most trusted brands.
//             </p>
//           </motion.div>
//         </div>
//       </section>

//       {/* 11 BRAND CARDS – MAIN SECTION */}
//       <section id="products" className="py-20 sm:py-24 relative overflow-hidden">
...
//             <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
//               Our team will guide you with specifications, product selection & bulk ordering.
//             </p>
...
//               <Link key={brand.slug} to={`/products/${brand.slug}`} className="block">
//                 <motion.div
//                   initial={{ opacity: 0, y: 30 }}
//                   whileInView={{ opacity: 1, y: 0 }}
//                   transition={{ duration: 0.6, delay: index * 0.08 }}
//                   viewport={{ once: true }}
//                   className="group bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 p-5 sm:p-6 flex flex-col items-center text-center cursor-pointer"
//                 >
            ...
            {brandCards.map((brand, index) => (
              ...
              <Link key={brand.slug} to={`/products/${brand.slug}`} className="block h-full">
                <motion.div
                  ...
                  transition-all duration-500 p-5 sm:p-6 
