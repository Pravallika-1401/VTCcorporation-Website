...
export default function Contact() {
  ...
  async function loadContact() {
    try {
      const data = await getSingleObject("contact");
      setContact(data);
    } catch (err) {
  ...
  const validateForm = () => {
    ...
    if (cleanedPhone.length === 10) {
      ...
      setErrorMessage(`Please enter a valid 10-digit phone number (found ${cleanedPhone.length} digits)`);
      setFormStatus("error");
      return false;
    }
  };
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full h-40 sm:h-52 lg:h-72 px-4 py-3 rounded-lg border border-gray-300 
                    focus:border-[#008c94] focus:ring-2 focus:ring-[#008c94]/20 
            ...
            >
              <div className="w-full h-full rounded-xl overflow-hidden">
                <iframe
                  src={contact?.google_map_embed_url || contact?.mapembedurl || `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3807.019004924767!2d83.3030478!3d17.728487!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a35eff9482d944b%3A0x939b1ad8d0c15e0f!2sDaba%20Gardens%2C%20Visakhapatnam%2C%20Andhra%20Pradesh%20530220%2C%20India!5e0!3m2!1sen!2sin!4v1670000000000!5m2!1sen!2sin`}
                  width="100%"
                  height="100%"
