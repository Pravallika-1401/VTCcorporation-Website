...
//                 <a href="tel:+91 9100023692" className="text-gray-300 hover:text-[#bba14f] transition-colors">
//                   +91 9100023692
//                 </a>
//                 <a href="tel:+91 9281452732" className="text-gray-300 hover:text-[#bba14f] transition-colors">
//                   +91 9281452732
//                 </a>
//               </li> */}
//              <li className="flex items-center gap-3">
...
//   <a
//     href="tel:+919100023692,+919281452732"
...
//             <div className="flex items-center gap-3 mb-6">
//               <div className="w-12 h-12 bg-gradient-to-br from-[#bba14f] to-[#d4b870] rounded-lg flex items-center justify-center">
//                 <img src={logo} alt="VTC Corporation Logo" className="w-12 h-12 object-contain rounded-lg shadow-lg" />
//               </div>
//               <div>
...
//             <div className="flex gap-3">
//               {socialLinks.map((social) => (
//                 <a key={social.label} href={social.href} className="w-10 h-10 bg-white/10 backdrop-blur-sm rounded-lg flex items-center justify-center hover:bg-[#bba14f] transition-all hover:scale-110">
//                   <social.icon className="w-5 h-5" />
//                 </a>
//               ))}
//             </div>
...
//             <h4 className="text-lg font-bold mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>Quick Links</h4>
//             <ul className="space-y-3">
//               {quickLinks.map((link) => (
//                 <li key={link.name}>
//                   <Link to={link.path} className="text-gray-300 hover:text-[#bba14f] transition-colors hover:translate-x-1 inline-block">
//                     {link.name}
//                   </Link>
//                 </li>
//               ))}
...
//             <h4 className="text-lg font-bold mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>Our Products</h4>
//             <ul className="space-y-3">
//               {productCategories.map((category) => (
//                 <li key={category}>
//                   <Link to={createPageUrl('Products')} className="text-gray-300 hover:text-[#bba14f] transition-colors hover:translate-x-1 inline-block">
//                     {category}
//                   </Link>
//                 </li>
//               ))}
...
//             <h4 className="text-lg font-bold mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>Contact Us</h4>

//             <ul className="space-y-4">
//               <li className="flex items-start gap-3">
//                 <MapPin className="w-5 h-5 text-[#bba14f]" />
...
//               <li className="flex items-center gap-3">
//                 <Phone className="w-5 h-5 text-[#bba14f]" />
//                 <a
//                   href="tel:+919100023692,+919281452732"
//                   className="text-gray-300 hover:text-[#bba14f]"
//                 >
//                   +91 9100023692 <br />
//                   +91 9281452732
//                 </a>
...
//                 <a href="mailto:vtc_corporation@yahoo.com" className="text-gray-300 hover:text-[#bba14f]">
//                   vtc_corporation@yahoo.com
//                 </a>
//               </li>
//             </ul>
...
//               Designed and Developed by{" "}
//               <a href="https://designblocks.in/" target="_blank" className="hover:text-[#bba14f]">
//                 DESIGN BLOCKS
//               </a>
//             </div>
//           </div>
...
//       <button
//         onClick={scrollToTop}
//         className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-br from-[#bba14f] to-[#d4b870] rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-all z-40"
//       >
//         <ArrowUp className="w-6 h-6 text-white" />
//       </button>
//     </footer>
  ...
  return (
    <footer className="bg-gradient-to-br from-[#0b2343] to-[#1a3a5c] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
        ...
        {/* Fully responsive grid — now 1/2/3 columns */}
            ...
            <ul className="space-y-4 text-sm sm:text-base">
              ...
              <li className="flex items-start gap-3">
                ...
                <div className="flex flex-col">
                  <a href="tel:+919100023692" className="text-gray-300 hover:text-[#bba14f]">+91 9100023692</a>
                  <a href="tel:+919281452732" className="text-gray-300 hover:text-[#bba14f]">+91 9281452732</a>
                </div>
              </li>
